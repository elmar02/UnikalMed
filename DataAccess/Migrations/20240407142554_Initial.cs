    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertLanguages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdvertLanguages_Adverts_AdvertId",
                        column: x => x.AdvertId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReferenceLanguages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReferenceLanguages_References_ReferenceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StaffLanguages_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WattValue = table.Column<int>(type: "int", nullable: true),
                    Guarantee = table.Column<int>(type: "int", nullable: true),
                    ShootCount = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WoltValue = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HeaderLanguages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HeaderLanguages_Headers_HeaderId",
                        column: x => x.HeaderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSpecifications_ProductLanguages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HeaderSpecifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HeaderSpecifications_HeaderLanguages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "HeaderLanguages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AdvertLanguages_AdvertId",
                table: "AdvertLanguages",
                column: "AdvertId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HeaderLanguages_HeaderId",
                table: "HeaderLanguages",
                column: "HeaderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HeaderSpecifications_LanguageId",
                table: "HeaderSpecifications",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSpecifications_LanguageId",
                table: "ProductSpecifications",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_ReferenceLanguages_ReferenceId",
                table: "ReferenceLanguages",
                column: "ReferenceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffLanguages_StaffId",
